        ...
        return (
            <Grid>
                ...
                <Cell col={8}>
                    ...
                    <h4>Preparation</h4>
                    <p>Researching a product, processes, and new ideas starts with three different questions:</p>
                    <ul>
                    ...
                    <p>Simply expressed, the Product Manager or entity carrying out the project must first understand what they need to look for in order to find the right materials. Next, find who does it the best. Want to be better at HR or Project Management, look to the Society of Human Resources Managers or the Project Management Institute. They have the experience that has built the best individuals in the industry and they have set products that they highly endorse. These products will then give you the needed information to understand how your product will need to meet and exceed expectations of these other products. Products are made to be the best by building off of solutions that pioneered the way.</p>
                    <h4>Building the Search String</h4>
                    <p>Getting all the information you need is pretty easy to do with the advent of Internet 2.0 and the ability to get information at our fingertips. The hard part is to decipher what is needed to build the best product, improve a process or achieve a grand idea.</p>
